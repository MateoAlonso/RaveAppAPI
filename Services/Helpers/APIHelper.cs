...
namespace RaveAppAPI.Services.Helpers
{
    public class ApiHelper
    {
        ...
        public static HttpRequestMessage BuildRequest(HttpMethod verb, string url, string endpoint, MultipartFormDataContent formData, AuthenticationHeaderValue auth = null, Dictionary<string, string?> headers = null)
        {
            HttpRequestMessage request = new HttpRequestMessage() { Method = verb, RequestUri = new Uri($"{url}{endpoint}") };
